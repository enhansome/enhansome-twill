# Awesome Twill with stars

> A curated list of awesome bookmarks, packages, tutorials, videos and other cool resources from the Twill community.

Inspired by and based on [chiraggude/awesome-laravel](https://github.com/chiraggude/awesome-laravel) ⭐ 13,088 | 🐛 85 | 📅 2024-07-03
...
* [GitHub Discussions](https://github.com/area17/twill/discussions) ⭐ 3,971 | 🐛 134 | 🌐 PHP | 📅 2026-07-31
...
* [Made with Twill Video Tutorials](https://twill.io/tutorials) ([Source Code](https://github.com/area17/made-with-twill-tutorials) ⭐ 7 | 🐛 5 | 🌐 PHP | 📅 2023-04-19)

#### Complete Tutorials

* [Build a CMS Stack with Laravel, Twill, Inertia, Vue 3, Vite, Tailwind](https://tech.codivores.com/series/laravel-twill-inertia) ([Source Code](https://github.com/Codivores/tutorial-laravel-twill-inertia-vue3-vite-tailwind) ⭐ 26 | 🐛 0 | 🌐 PHP | 📅 2024-05-22)
* [Step by step - Creating a Twill app](https://spectrum.chat/twill/tips-and-tricks/step-by-step-creating-a-twill-app~ac9bd7f7-d1e3-46a8-8e6f-6075d92cdac7) ([Source Code](https://github.com/sauron/my-twill-blog) ⭐ 17 | 🐛 0 | 🌐 PHP | 📅 2019-04-01)
...
* [Art Institute of Chicago](https://www.artic.edu/) ([Source Code](https://github.com/art-institute-of-chicago/artic.edu) ⭐ 32 | 🐛 20 | 🌐 PHP | 📅 2026-08-13) - Website of the Art Institute of Chicago
...
* [Feature Flags](https://github.com/area17/twill-capsule-feature-flags) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2024-07-10 - This Capsule allows you to easily enable/disable features on your application
* [Twill Redirects](https://github.com/Sevendays-Digital/twill-redirects) ⭐ 8 | 🐛 2 | 🌐 PHP | 📅 2023-12-07 - Manage redirects in Twill
* [Homepages Capsule](https://github.com/area17/twill-capsule-homepages) ⭐ 6 | 🐛 2 | 🌐 PHP | 📅 2022-11-29 - A Twill Capsule to create a Home page for your website
* [Twill Capsules Base](https://github.com/area17/twill-capsule-base) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2021-09-04 - A series of opinionated base classes and helpers for faster application bootstrapping using Twill and Capsules
* [Cities Capsule](https://github.com/area17/twill-capsule-cities) ⭐ 2 | 🐛 0 | 🌐 PHP | 📅 2021-09-04 - A Twill Capsule to help you manage a list of Cities
* [Countries Capsule](https://github.com/area17/twill-capsule-countries) ⭐ 2 | 🐛 0 | 🌐 PHP | 📅 2021-09-04 - A Twill Capsule to help you manage a list of Countries
* [Redirections](https://github.com/area17/twill-capsule-redirections) ⭐ 1 | 🐛 1 | 🌐 PHP | 📅 2022-04-28 - A Twill Capsule to manage and handle application redirections
...
* [Twill API](https://github.com/area17/twill-api) ⭐ 14 | 🐛 3 | 🌐 PHP | 📅 2024-01-10 - Provide a read-only API to Twill models and entities
* [Twill Transformers](https://github.com/area17/twill-transformers) ⭐ 11 | 🐛 1 | 🌐 PHP | 📅 2023-04-19 - A base Transformer class and a series of traits to generate view data for your Twill app
* [Twill GraphQL](https://github.com/kallefrombosnia/twill-graphql) ⭐ 8 | 🐛 3 | 🌐 PHP | 📅 2023-04-24 - Provides GraphQL wrapper for Twill CMS

#### Form Fields

* [Twill Form Templates](https://github.com/pboivin/twill-form-templates) ⚠️ Archived - A template field for Twill Modules
* [Twill FormField partials](https://github.com/sauron/twill-form-partials) ⭐ 0 | 🐛 1 | 🌐 Blade | 📅 2021-10-08 - A set of FormFields for Twill CMS in order to standardise it and speed up the Development time
...
* [Twill Croppa](https://github.com/c2h6-383/twill-croppa) ⭐ 1 | 🐛 0 | 🌐 PHP | 📅 2025-10-25 - Use the advantages of [Croppa](https://github.com/BKWLD/croppa) ⭐ 506 | 🐛 23 | 🌐 PHP | 📅 2026-07-15 in your Twill application, provided by a custom image rendering service

#### Metadata & SEO

* [Twill Metadata](https://github.com/cwsdigital/twill-metadata) ⭐ 33 | 🐛 3 | 🌐 PHP | 📅 2024-09-13 - A simple way to add editable SEO metadata to your Twill models
